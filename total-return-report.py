...
heroes-and-villains-report.py). This file covers period/table layout and HTML rendering.
"""
...
from calculations import (
    ...
    prev_quarter,
    quarter_bounds,
    quarter_label as _quarter_label,
    state_on,
    twr,
)
from config import (
...
def annualise(cumulative_return: Decimal | None, start: date, end: date) -> Decimal | None:
    return _annualise(cumulative_return, start, end, ANN_MIN_DAYS)
